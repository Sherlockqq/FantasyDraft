...
class StickyHeaderItemDecoration(private val sectionCallback: SectionCallback) : RecyclerView.ItemDecoration() {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        /* 헤더 */
        val currentHeader: View = sectionCallback.getHeaderLayoutView(
            parent,
            topChildPosition) ?: return
        /* View의 레이아웃 설정 */
        ...
        if (childAdapterPosition == -1) return when {
    ...
    private fun fixLayoutSize(parent: ViewGroup, view: View, height: Int) {
        ...
        val heightSpec = View.MeasureSpec.makeMeasureSpec(
            parent.height, View.MeasureSpec.EXACTLY )
